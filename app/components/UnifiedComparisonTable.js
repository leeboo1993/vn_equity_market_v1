                ...
                <table className="mini-table w-full relative border-collapse" style={{ tableLayout: 'fixed' }}>
                    ...
                    <thead>
                        <tr style={{
                            ...
                            <th style={{ padding: '8px 16px', textAlign: 'left' }}>Metric</th>
                            {tableData.columns.map((col, idx) => (
                                <th key={idx} style={{ padding: '8px 16px', textAlign: 'center' }}>
                                    {tableData.getColumnHeader(col)}
                                </th>
                            ))}
                            <th style={{ padding: '8px 16px', textAlign: 'center' }}>Δ</th>
                        </tr>
                    </thead>
                        ...
                        {mode !== 'historical' && (
                            <tr style={{ borderBottom: '1px solid #2A2A2A' }}>
                                ...
                                {tableData.columns.map((col, colIdx) => (
                                    <td key={colIdx} style={{ padding: '8px 16px', textAlign: 'center' }}>
                                        {formatDate(col.info_of_report?.date_of_issue)}
                                    </td>
                                ))}
                                <td style={{ padding: '8px 16px', textAlign: 'center' }}>-</td>
                            </tr>
                        )}
                            ...
                            return (
                                <tr key={metric.key} style={{ borderBottom: '1px solid #2A2A2A' }}>
                                    ...
                                    {tableData.columns.map((col, colIdx) => {
                                        ...
                                        return (
                                            <td key={colIdx} style={{ padding: '12px 16px', textAlign: 'center' }}>
                                                {value || '-'}
                                            </td>
                                        );
                                    })}
                                    <td style={{ padding: '8px 16px', textAlign: 'center' }}>{delta || '-'}</td>
                                </tr>
                            );
                        })}
                    </tbody>
