...
// Map to cache RAW reports in memory (without enrichment)
let cachedRawReports = null;

// New Optimized Function: Get Raw Reports (No Enrichment)
export async function getRawReports() {
    if (cachedRawReports) return cachedRawReports;
